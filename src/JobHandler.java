public class JobHandler {
	...
	public static int rank(int warningTotals, double yearlySalary) {
		...
		if(yearlySalary>=100000) currentRank= 80;
		else if(yearlySalary>=50000) currentRank= 60;
		else if(yearlySalary>=10000) currentRank=40;
		else if(yearlySalary>0) currentRank= 20;
	...
	public static boolean promotionQualify(boolean availability, boolean jobType, int jobRank, int eRank, int seniority) {
		...
		if(eRank>=jobRank || !jobType) qualify=true;
